...
bg_menu = pygame.image.load('img/jpg/phonk.jpg').convert()
...
bg_training = pygame.image.load('img/jpg/trainphonk.jpg').convert()
btn_pause = pygame.image.load('img/png/buttons/butnonpfublyatbutton.png').convert_alpha()
btn_restart = pygame.image.load('img/png/buttons/btnrestart.png').convert_alpha()
clock = pygame.time.Clock()
FPS = 60  # на 600 прям летает!
